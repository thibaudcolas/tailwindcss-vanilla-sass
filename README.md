# [tailwindcss-vanilla-sass](https://www.npmjs.com/package/tailwindcss-vanilla-sass)

[![npm](https://img.shields.io/npm/v/tailwindcss-vanilla-sass.svg)](https://www.npmjs.com/package/tailwindcss-vanilla-sass) [![Build status](https://github.com/thibaudcolas/tailwindcss-vanilla-sass/workflows/CI/badge.svg)](https://github.com/thibaudcolas/tailwindcss-vanilla-sass/actions)
...
```js
const vanillaRTL = require("tailwindcss-vanilla-sass");
...
| tailwindcss-vanilla-sass                                          | tailwindcss-rtl | tailwindcss-logical |
| ----------------------------------------------------------------- | --------------- | ------------------- |
